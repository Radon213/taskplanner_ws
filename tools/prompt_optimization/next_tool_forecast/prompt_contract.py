...
def _base_system_prompt() -> str:
    return (
        ...
        "phase label, current-tool label, speech-intent label, hand state, "
        "or a command. Use only the supplied chronological images and "
...
OPTIMIZED_DEVELOPER_PROMPT = (
    ...
    "FLIR frames oldest-to-newest for a concrete operative trajectory and the "
        "CAM4 frames oldest-to-newest for a distinct Mayo tool-flow trajectory. "
